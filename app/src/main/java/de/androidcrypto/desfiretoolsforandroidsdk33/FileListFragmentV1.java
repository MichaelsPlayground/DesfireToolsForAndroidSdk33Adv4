...
public class FileListFragmentV1 extends Fragment {
	...
	public static FileListFragmentV1 newInstance(String param1, String param2) {
		FileListFragmentV1 fragment = new FileListFragmentV1();
